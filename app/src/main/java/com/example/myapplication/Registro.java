        ...
        mAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(Registro.this, "¡Registro exitoso! Bienvenido.",
                        ...
                        Toast.makeText(Registro.this, "Fallo el registro: " + errorMessage,
        ...
        mDatabase.child("users").child(uid).setValue(userData)
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(Registro.this, "Advertencia: No se pudieron guardar los datos delb perfil.", Toast.LENGTH_LONG).show();
                    }
                });
    }
